...
class I2C:
    ...
    def readfrom_mem(self, address: int, register: int, size: int) -> bytes: ...
    def readfrom_mem_into(self, address: int, register: int, buf: bytes) -> None: ...
    def readinto() -> None: ...
    def scan() -> list[int]: ...
    def start() -> None: ...
    def stop() -> None: ...
    def write() -> None: ...
    def writeto() -> None: ...
    def writeto_mem(self, address: int, register: int, value: bytes) -> None: ...
    def writevto() -> None: ...
...
class Pin:
    ...
    WAKE_LOW = 4
    def __init__(
        self, no: int, mode: int = Pin.OUT, use_pull_up: Optional[int] = None
    ): ...
    def init() -> None: ...
    def irq() -> None: ...
    def off() -> None: ...
